                        ...
                        @foreach($model as $key => $complaint)
                            <tr>
                                ...
                                <td>
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <select class="form-control complaintStatus" data-id="{{$complaint->id}}"
                                                    name="complaintStatus" style="width: 100%;">
                                                <option value="0" {{$complaint->status==0 ? 'selected':''}} > On Hold
                                                </option>
                                                <option value="1" {{$complaint->status==1 ? 'selected':''}} >In
                                                    Process
                                                </option>
                                                <option value="2" {{$complaint->status==2 ? 'selected':''}} > Solved
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <td class="action-width">
                                    <a href="{{route('complaintView',$complaint->id)}}"
                                       class="btn btn-block btn-primary btn-flat"> <i class="fa fa-edit"></i> View </a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
