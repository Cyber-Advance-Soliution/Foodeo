			...
			<div class="tab-content">
				<div class="tab-pane active" id="settings">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
							  <input readonly type="email" class="form-control" value="{{$Customer_info->username}}">
							</div>
						</div>
                        <div class="form-group row">
							<label for="inputName" class="col-sm-2 col-form-label">Phone</label>
							<div class="col-sm-10">
							  <input readonly type="email" class="form-control" value="{{$Customer_info->phone_number}}">
							</div>
						</div>
                        <div class="form-group row">
