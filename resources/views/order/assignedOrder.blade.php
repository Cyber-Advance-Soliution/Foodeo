            ...
            <div class="card-header">
				...
				@can('recieve-orders')
					<div class="card-tools">
						<a href="{{ route('recieve-orders') }}" class="btn btn-success btn-sm"> <i class="far fa-circle nav-icon"></i> Assigned  Orders  </a>
					</div>
				@endcan
            </div>
            <!-- /.card-header -->
				...
				<table id="assign-orders" class="table table-bordered table-hover">
					...
					<tbody>
							...
							<tr id="{{ $key }}">
								...
								<td> <a href="{{ route('view-order', ['id' => $order->id]) }}">{{$orderReference  }} </a></td>
