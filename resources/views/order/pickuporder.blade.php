			...
			<div class="modal-body">
				<form action="{{ route('update-order') }}" method="post" role="form">
					...
					<div class="form-group">
						<label> Status </label>
						<select class="form-control" id="order-status" name="order_status" style="width: 100%;" required>
		  ...
		  <div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{ route('update-order') }}" method="post" role="form">
					...
					<div class="form-group">
						<label> Status </label>
						<select class="form-control select2" id="order-status" name="order_status" style="width: 100%;" required>
							<option selected="selected"> -- Select -- </option>
						</select>
					</div>
				...
				<table id="manage-orders" class="table table-bordered table-hover">
					...
					<tbody>
							...
							<tr id="{{ $key }}">
								...
								<td>  
									<a href="javascript://" onclick="statusList({{ $order->id }})" id="{{ $key }}" class="btn btn-block btn-success btn-flat">  <i class="fa fa-edit"></i> Edit</a>						
								</td>
							</tr>
							@endforeach
					</tbody>
