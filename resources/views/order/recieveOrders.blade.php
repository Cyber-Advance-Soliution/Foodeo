            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!--<div class="form-group">
                        ...
                        <div class="form-group">
                            <label> Status </label>
                            <select class="form-control" required id="order-status" name="order_status"
                                    style="width: 100%;">
                                <option selected="selected"> -- Select --</option>
                            </select>
                        </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('manage-orders') }}" class="btn btn-success btn-sm"> <i
                                class="fa fa-tasks nav-icon"></i> Manage Orders </a>
                    </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        @foreach($model as $key => $order)
                            <tr id="{{ $key }}">
                                ...
                                <td>
                                    ...
                                    <a href="javascript://" onclick="updateOrder({{ $order->id }}, 6, this.id)"
