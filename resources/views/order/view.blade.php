...
@section('content')
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-sm-12">
                    ...
                    <div class="mt-4 text-center"><strong> Location of Order # {{ $model->order_reference }} </strong>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="invoice p-3 mb-3">
        ...
        <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
                ...
                <address>
                    ...
                    Contact
                    : {{ $model->customer->customerDetail->phone_number ?  $model->customer->customerDetail->phone_number : 'NA' }}
                </address>
            </div>
            ...
            <div class="col-sm-4 invoice-col">
                ...
                <address>
                    ...
                    <p> Location : <a target="_blank"
                                      href="{{ url('view-location', ['id' => $model->id]) }}"> {{ $orderLocation ? $orderLocation : 'Click here to view your order location.' }} </a>
                    </p>
            ...
            <div class="col-sm-4 invoice-col">
                ...
                <address>
                    ...
                    <p> Location : <a target="_blank"
                                      href="{{ url('view-location', ['id' => $model->id]) }}"> {{ $storeLocation ? $storeLocation : 'Click here to view your store location.' }} </a>
                    </p>
        ...
        <div class="row no-print">
            <div class="col-12">
                <a href="javascript://" onclick="printOrder()" target="_blank" class="btn btn-default"><i
