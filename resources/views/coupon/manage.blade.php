            ...
            <div class="card-header">
              ...
              <h3 class="card-title"> Coupon Listed </h3>
				<div class="card-tools">
					<a href="{{ route('create-coupon') }}" class="btn btn-success btn-sm"> <i class="fa fa-plus"></i> Add Coupon</a>
				</div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
          					...
          					<tr>
                                ...
                                <td> {{ isset($coupon->value)?  $coupon->value:'' }} </td>
          						...
          						<td class="action-width"> 
          							<a href="{{ route('edit-coupon', ['id' => $coupon->id]) }}" class="btn btn-block btn-primary btn-flat"> <i class="fa fa-edit"></i> Edit </a> 
                                      <a href="{{ route('delete-coupon', ['id' => $coupon->id]) }}" class="btn btn-block btn-primary btn-flat"> <i class="fa fa-edit"></i>Delete</a> 
          						</td>
          					</tr>
          					@endforeach
                </tbody>
