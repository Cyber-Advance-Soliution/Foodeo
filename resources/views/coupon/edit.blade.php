				...
				<form action="{{ route('coupon-update') }}" method="post" role="form">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="code" name="code" placeholder="Enter code like foodeo234" value="{{isset($model->code)? $model->code:''}}">
						</div>
						...
						<div class="form-group">
							...
							<select class="form-control select2" name="type" style="width: 100%;">
								<option value="" selected="selected"> -- Select coupon type -- </option>
									<option value="{{$model->type}}" {{isset($model->type)? 'selected':''}}>percentage</option>
						...
						<div class="form-group">
							...
							<input type="number" class="form-control" id="value" name="value" placeholder="Enter value" value="{{isset($model->value)? $model->value:''}}">
						</div>
					</div>
