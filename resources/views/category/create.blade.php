    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-success">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('create-category') }}" id="create-category-form" method="post" role="form"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file mb-2">
                                ...
                                <label class="custom-file-label" id="category_icon_label" for="category_icon_label">Choose
                                    Icon</label>
                            </div>
                        </div>
                    </div>
