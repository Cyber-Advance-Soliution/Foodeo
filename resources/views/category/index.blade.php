            ...
            <div class="card-header">
              <h3 class="card-title"> All Categories Listed </h3>
				<div class="card-tools">
                	<a href="{{ route('new-category') }}" class="btn btn-success btn-sm"> <i class="fa fa-plus"></i> Add Category </a>
				</div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table style="width:100%" id="categories" class="table table-bordered table-hover table-responsive">
                ...
                <tbody>
					...
					<tr>
						...
						<td class="action-width">  <a href="{{ route('category-edit', ['id' => $category->id]) }}" class="btn btn-block btn-success" title="Edit Category"><i class="fa fa-edit"></i> Edit </a> </td>
					</tr>
					@endforeach
                </tbody>
                <tfoot>
