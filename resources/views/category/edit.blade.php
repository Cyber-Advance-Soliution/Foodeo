    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-success">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('update-category') }}" method="post" role="form" id="update-category-form"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="store_id" style="width: 100%;">
                                ...
                                @foreach($stores as $store)
                                    <option
                                        value="{{ $store->id }}" {{ ($store->id == $model[0]->store_id) ? 'selected' : '' }}>{{ $store->store_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="category_name" name="category_name"
                                   value="{{ $model[0]->category_name ? $model[0]->category_name : '' }}"
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="category_icon"
                                           name="category_icon">
                                    <label class="custom-file-label" id="category_icon_label" for="category_icon_label">
                                        Choose Icon </label>
                                </div>
                            </div>
                        </div>
