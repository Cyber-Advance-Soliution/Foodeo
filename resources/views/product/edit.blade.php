    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-success">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('update-product') }}" method="post" role="form" id="create-product-form"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label> Store </label>
                            <select class="form-control select2" onchange="store_product_categories(this.value)"
                                    name="store_id" style="width: 100%;">
                                <option value=""> -- Select Store --</option>
                                @foreach($stores as $store)
                                    <option
                                        value="{{ $store->id }}" {{ ($model->store_id == $store->id) ? 'selected' : '' }} >{{ $store->store_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Product Category</label>
                            <select class="form-control select2" id="product_category_id" name="product_category_id"
                                    style="width: 100%;">
                                <option value=""> -- Select Product Category --</option>
                                @foreach($productCategories as $category)
                                    <option
                                        value="{{ $category->id }}" {{ ($model->product_category_id == $category->id) ? 'selected' : '' }} >{{ $category->category_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1"> Product Name </label>
                            <input type="text" class="form-control" id="product_name" value="{{ $model->product_name }}"
                                   name="product_name" placeholder="Enter Product Name">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Product Price </label>
                            <input type="text" class="form-control" id="product_price"
                                   value="{{ $model->product_price }}" name="product_price"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="long_description" name="long_description"
                                   value="{{ $model->long_description }}" placeholder="Enter Long Description">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file mb-2">
                                ...
                                <label class="custom-file-label" id="product_thumbnail_label" for="exampleInputFile">Choose
                                    Thumbnail</label>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file mb-2">
                                <input type="file" class="custom-file-input" id="product_banners"
                                       name="product_banners[]" multiple>
                                <label class="custom-file-label" id="product_banners_labels" for="exampleInputFile">Choose
                                    Banners</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 product-image-thumbs">
                                @foreach($model->productBanners as $product)
                                    <div class="product-image-thumb"><img src="/{{ $product->banner }}"
                                    ...
                                    <div class="card card-success">
                                        <div class="card-header">
                                            ...
                                            <div class="card-tools">
                                                ...
                                                @if($parentKey > 0)
                                                    <button type="button" class="btn btn-tool btn_remove"
                                                            id="{{ $parentKey }}"><i class="fas fa-minus"></i></button>
                                                @endif
                                                <button type="button" class="btn btn-tool" onclick="addCard()" id="add">
                                                ...
                                                <div class="row" id="row{{ $key }}">
                                                    ...
                                                    @if($key == 0)
                                                        <div class="col-md-1">
                                                            ...
                                                            <button type="button" onclick="addOption(this.id)"
                                                                    id="{{ $parentKey }}"
                                                    ...
                                                    @else
                                                        <div class="col-md-1">
                                                            ...
                                                            <button type="button" id="{{ $key }}"
                                                                    class="btn btn-success btn-md btn_remove_one"><i
