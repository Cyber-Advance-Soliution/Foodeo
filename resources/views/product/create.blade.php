    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-success">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('create-product') }}" method="post" role="form" id="create-product-form"
                            ...
                            <div class="card card-success">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        ...
                                        <button type="button" class="btn btn-tool" onclick="addCard()" id="add"><i
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="attribute_name"
                                                       name="attribute_name[]" placeholder="Enter Name">
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="option" name="option[0][]"
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="option_value"
                                                       name="option_value[0][]" placeholder="Enter Option Value">
                                            </div>
                                            <!-- /.col -->
                                        </div>
                                        <div class="col-md-1">
                                            <label for="exampleInputPassword1"> &nbsp; </label>
                                            <button type="button" onclick="addOption(this.id)" id="0"
                                                    class="btn btn-success btn-md"><i class="fas fa-plus"></i></button>
                                        </div>
                                        <!-- /.row -->
                                    </div>
                                </div>
			...
			<div class="card-body attribute-option-' + i + '"> \
				<div class="row"> \
					...
					<div class="col-md-5"> \
						<div class="form-group"> \
							<label for="exampleInputPassword1"> Value </label> \
							<input type="number" class="form-control" id="option_value" name="option_value[' + i + '][]" placeholder="Enter Option Value"> \
						</div>	 \
					</div> \
					<div class="col-md-1"> \
						<label for="exampleInputPassword1">  &nbsp; </label> \
    ...
    function addOption(attributeId) {
        ...
        $('.attribute-option-' + attributeId).append('<div class="row" id="row' + j + '"> \
			...
			<div class="col-md-5"> \
				<div class="form-group"> \
					<label for="exampleInputPassword1"> Value </label> \
					<input type="number" class="form-control" id="option_value" name="option_value[' + i + '][]" placeholder="Enter Value"> \
				</div>	\
			</div> \
			<div class="col-md-1"> \
				<label for="exampleInputPassword1">  &nbsp; </label> \
