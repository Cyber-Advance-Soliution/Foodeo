        ...
        <div class="card-body">
			<div class="row">
				<div class="col-12 col-sm-6">
					...
					<div class="col-12">
						<img id="image-view" src="/{{ $model->product_thumbnail }}" class="product-image" alt="Product Image">
					</div>
					<hr>
					<div class="col-12 product-image-thumbs">
						@foreach($model->productBanners as $product)
							<div class="product-image-thumb active"><img onclick="replaceImage(this.src)" src="/{{ $product->banner }}" alt="Product Image"></div>
						@endforeach	
					</div>
				</div>
				<div class="col-12 col-sm-6">
