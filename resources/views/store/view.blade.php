        ...
        <div class="card-body">
			<div class="row">
				<div class="col-12 col-sm-6">
					...
					<div class="col-12">
						<img id="image-view" src="/{{ $model->store_thumbnail }}" class="product-image" alt="Product Image">
					</div>
					<hr>
				...
				<div class="col-12 col-sm-6">
					...
					<p>  <a target="_blank" href="{{ url('view-location', ['id' => $model->id]) }}"> {{ $storeAddress ? $storeAddress : 'Click here to view your store location.' }} </a></p>
