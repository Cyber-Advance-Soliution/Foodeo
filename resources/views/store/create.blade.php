	...
	<div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-success">
				...
				<!-- /.card-header -->
				<!-- form start -->
				<form action="{{ route('create-store') }}" id="create-store-form" method="post" role="form" enctype="multipart/form-data">
					@csrf 
					<div class="card-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="store_email" name="store_email" placeholder="Enter Store Email">
						</div>
						
						<div class="form-group">
							<label for="exampleInputEmail1"> Store Contact </label>
							<input type="text" class="form-control" id="store_contact" name="store_contact" placeholder="Enter Store Contact">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="long_description" name="long_description" placeholder="Enter Long Description...">
						</div>
						
						<div class="form-group">
							<div class="form-check">
								<input class="form-check-input" type="checkbox" onclick="valueCheck(this.id, this.value)" id="customer_pickup" name="customer_pickup" value="0">
						...
						<div class="form-group">
							<div class="form-check">
								<input class="form-check-input" type="checkbox" onclick="valueCheck(this.id, this.value)" id="delivery_to_customer" name="delivery_to_customer" value="0">
						...
						<div class="form-group">
							<div class="form-check">
								<input class="form-check-input" type="checkbox"  onclick="valueCheck1(this.id, this.value)" id="cash_on_delivery" name="cash_on_delivery" value="0">
						...
						<div class="form-group" id="deliveryCharges" hidden>
							...
							<input type="text" class="form-control" id="delivery_charges" name="delivery_charges" placeholder="Enter Delivery Charges">
						</div>
						
						<div class="form-group">
							<label for="exampleInputFile"> Location </label>
							<input id="locations_filter" name="location" type="text" class="form-control"  placeholder="Location" />
						...
						<div class="form-group">
							...
							<div class="custom-file mb-2">
								...
								<label class="custom-file-label" id="store_banners_labels" for="store_banners_labels">Choose Banners</label>
							</div>
						</div>
...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBz1jMjJPw1KIAoGbsESx0-4iMTDmLf7nw&amp;libraries=places"></script> 
<!-- Bootstrap 4 -->
