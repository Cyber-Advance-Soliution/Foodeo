            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('new-rider') }}" class="btn btn-success btn-sm"> <i class="fa fa-plus"></i>
                            Add rider </a>
                    </div>
                </div>
                <!-- /.card-header -->
                    ...
                    <table id="riders" class="table table-bordered table-hover table-responsive">
                        ...
                        @foreach($model as $key => $rider)
                            <tr>
                                <td> {{ ++$i }} </td>
                                <td>
                                    <a href="{{ route('view-rider', ['id' => $rider->id]) }}">{{ $rider->riderDetail->name }} </a>
                                </td>
                                <td> {{ $rider->username }} </td>
                                <td> {{ $rider->email }} </td>
                                <td> {{ $rider->riderDetail->phone_number }} </td>
                                <td class="action-width">
                                    <a href="{{ route('edit-rider', ['id' => $rider->id]) }}"
