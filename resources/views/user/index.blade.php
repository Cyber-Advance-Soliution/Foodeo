            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('new-user') }}" class="btn btn-success btn-sm"> <i class="fa fa-plus"></i>
                            Create User </a>
                    </div>
                </div>
                <!-- /.card-header -->
                        ...
                        <table id="users" class="table table-bordered table-hover  table-responsive">
                            ...
                            @foreach($model as $key => $user)
                                <tr id="{{ $key }}">
                                    <td> {{ ++$i }} </td>
                                    <td>
                                        <a href="{{ route('edit', ['id' => $user->id]) }}"> {{ $user->userDetail ? $user->userDetail->name : ''  }} </a>
                                    </td>
                                    <td> {{ $user->email }} </td>
                                    ...
                                    <td>
                                        <a href="{{ route('edit', ['id' => $user->id]) }}"
                                           class="btn btn-block btn-success btn-flat"> <i class="fa fa-check"></i> Edit
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
