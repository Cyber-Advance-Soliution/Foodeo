          ...
          <div class="card">
            <div class="card-header">
				...
				<div class="card-tools">
					<a href="{{ route('new-employee') }}" class="btn btn-success btn-sm"> <i class="fa fa-plus"></i> Add Employee </a>
				</div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="employees" class="table table-bordered table-hover table-responsive">
                ...
                <tbody>
					...
					<tr>
						<td> {{ ++$i }} </td>
						<td> <a href="{{ route('view-employee', ['id' => $employee->id]) }}">{{ $employee->userDetail->name }} </a> </td>
						...
						<td class="action-width"> 
							<a href="{{ route('edit-employee', ['id' => $employee->id]) }}" class="btn btn-block btn-primary btn-flat"> <i class="fa fa-edit"></i> Edit </a> 
						</td>
					</tr>
					@endforeach
                </tbody>
