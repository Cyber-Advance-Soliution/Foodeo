            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    <div class="text-center">
                        <img class="profile-user-img img-fluid img-circle" src="{{ asset('admin') }}/assets/logo.png"
                ...
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link active"
                                                href="{{ route('edit-employee', ['id' => $model->id]) }}"> <i
                        ...
                        <div class="tab-pane active" id="settings">
                            <form class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input readonly type="email" class="form-control"
                                               value="{{ $model->userDetail->store->store_name }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input readonly type="text" class="form-control"
                                               value="{{ $model->userDetail->phone_number }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input readonly type="text" class="form-control"
                                               value="{{ $model->userDetail->address }}">
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="form-check">
                                                    ...
                                                    <label
                                                        class="form-check-label">  {{ ucwords($permission->name) }}</label>
                                                </div>
                                            </div>
                                        </div>
